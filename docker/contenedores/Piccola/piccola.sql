...
use master
GO
drop database if exists piccola
GO

create database piccola
go
...
CONSTRAINT fkpizza FOREIGN KEY (idPizza) REFERENCES Pizzas(idPizza),
CONSTRAINT fkIngrediente FOREIGN KEY (idIngrediente) REFERENCES Ingredientes(idIngrediente),
)
...
constraint fkPizzadetalle FOREIGN KEY(idPizza) REFERENCES pizzas(idpizza),
...
insert into PizzaIngredientes
values
((select idPizza from pizzas where nombre='Carbonara'),(Select idIngrediente from ingredientes where nombre='cebolla')),
((select idPizza from pizzas where nombre='Carbonara'),(Select idIngrediente from ingredientes where nombre='champiñones')),
((select idPizza from pizzas where nombre='Carbonara'),(Select idIngrediente from ingredientes where nombre='bacon')),
((select idPizza from pizzas where nombre='Frankfurt'),(Select idIngrediente from ingredientes where nombre='cebolla')),
((select idPizza from pizzas where nombre='Frankfurt'),(Select idIngrediente from ingredientes where nombre='salchicha')),
((select idPizza from pizzas where nombre='Frankfurt'),(Select idIngrediente from ingredientes where nombre='bacon')),
((select idPizza from pizzas where nombre='Magnifica'),(Select idIngrediente from ingredientes where nombre='cebolla')),
((select idPizza from pizzas where nombre='Magnifica'),(Select idIngrediente from ingredientes where nombre='parmesano')),
((select idPizza from pizzas where nombre='Magnifica'),(Select idIngrediente from ingredientes where nombre='albahaca')),
((select idPizza from pizzas where nombre='Popeye'),(Select idIngrediente from ingredientes where nombre='Espinacas')),
((select idPizza from pizzas where nombre='Popeye'),(Select idIngrediente from ingredientes where nombre='parmesano')),
((select idPizza from pizzas where nombre='4 Quesos'),(Select idIngrediente from ingredientes where nombre='roquefort')),
((select idPizza from pizzas where nombre='4 Quesos'),(Select idIngrediente from ingredientes where nombre='queso de cabra')),
((select idPizza from pizzas where nombre='4 Quesos'),(Select idIngrediente from ingredientes where nombre='parmesano')),
((select idPizza from pizzas where nombre='Curry'),(Select idIngrediente from ingredientes where nombre='Pollo')),
((select idPizza from pizzas where nombre='Curry'),(Select idIngrediente from ingredientes where nombre='cebolla')),
((select idPizza from pizzas where nombre='Curry'),(Select idIngrediente from ingredientes where nombre='Champiñones'))

insert into PizzaIngredientes
values
((select idPizza from pizzas where nombre='vegetal'),(Select idIngrediente from ingredientes where nombre='cebolla')),
((select idPizza from pizzas where nombre='vegetal'),(Select idIngrediente from ingredientes where nombre='champiñones')),
((select idPizza from pizzas where nombre='vegetal'),(Select idIngrediente from ingredientes where nombre='calabacín')),
((select idPizza from pizzas where nombre='vegetal'),(Select idIngrediente from ingredientes where nombre='pimiento rojo'))

insert into PizzaIngredientes
values
((select idPizza from pizzas where nombre='Mexicana'),(Select idIngrediente from ingredientes where nombre='cebolla')),
((select idPizza from pizzas where nombre='Mexicana'),(Select idIngrediente from ingredientes where nombre='Pollo')),
((select idPizza from pizzas where nombre='Mexicana'),(Select idIngrediente from ingredientes where nombre='queso de cabra')),
((select idPizza from pizzas where nombre='Mexicana'),(Select idIngrediente from ingredientes where nombre='pimiento rojo'))

insert into PizzaIngredientes
values
((select idPizza from pizzas where nombre='Barbacoa'),(Select idIngrediente from ingredientes where nombre='cebolla')),
((select idPizza from pizzas where nombre='Barbacoa'),(Select idIngrediente from ingredientes where nombre='bacon')),
((select idPizza from pizzas where nombre='Barbacoa'),(Select idIngrediente from ingredientes where nombre='salsas varias')),
((select idPizza from pizzas where nombre='Barbacoa'),(Select idIngrediente from ingredientes where nombre='pimiento rojo'))

insert into PizzaIngredientes
values
((select idPizza from pizzas where nombre='Hawaiana'),(Select idIngrediente from ingredientes where nombre='York')),
((select idPizza from pizzas where nombre='Hawaiana'),(Select idIngrediente from ingredientes where nombre='Pollo')),
((select idPizza from pizzas where nombre='Hawaiana'),(Select idIngrediente from ingredientes where nombre='Piña'))

insert into PizzaIngredientes
values
((select idPizza from pizzas where nombre='Bambina'),(Select idIngrediente from ingredientes where nombre='cebolla')),
((select idPizza from pizzas where nombre='Bambina'),(Select idIngrediente from ingredientes where nombre='Bacon')),
((select idPizza from pizzas where nombre='Bambina'),(Select idIngrediente from ingredientes where nombre='queso de cabra'))

insert into PizzaIngredientes
values
((select idPizza from pizzas where nombre='De la casa'),(Select idIngrediente from ingredientes where nombre='cebolla')),
((select idPizza from pizzas where nombre='De la casa'),(Select idIngrediente from ingredientes where nombre='Bacon')),
((select idPizza from pizzas where nombre='De la casa'),(Select idIngrediente from ingredientes where nombre='Pollo')),
((select idPizza from pizzas where nombre='De la casa'),(Select idIngrediente from ingredientes where nombre='Champiñones'))


Declare @idpizza int 

set @idpizza=(select idPizza from pizzas where nombre='Primavera')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('Champiñones','cebolla','atun','Queso de cabra')



set @idpizza=(select idPizza from pizzas where nombre='Burguer')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('Ternera','cebolla','salsas varias')


set @idpizza=(select idPizza from pizzas where nombre='Sabrosa')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('nueces','gorgonzola')


set @idpizza=(select idPizza from pizzas where nombre='japo')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('pollo','cebolla','champiñones')

set @idpizza=(select idPizza from pizzas where nombre='camembert')
insert into PizzaIngredientes
select @idpizza,idIngrediente  from Ingredientes where nombre in ('cherries','camembert')



set @idpizza=(select idPizza from pizzas where nombre='Capricho')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('pollo','pepperoni','york','ternera')


set @idpizza=(select idPizza from pizzas where nombre='Pedro Ximénez')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('ternera','cebolla','calabacin','Pimiento rojo')


set @idpizza=(select idPizza from pizzas where nombre='Ibérica')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('Serrano','cherries','parmesano','queso de cabra')


set @idpizza=(select idPizza from pizzas where nombre='Aniversario')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('ternera','cebolla','champiñones','aceitunas','york','parmesano')


set @idpizza=(select idPizza from pizzas where nombre='Rúcula')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('rúcula','Serrano','parmesano')


set @idpizza=(select idPizza from pizzas where nombre='Rústica')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('serrano','cebolla','champiñones','camembert')


set @idpizza=(select idPizza from pizzas where nombre='Buona')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('gorgonzola','ternera','champiñones')


set @idpizza=(select idPizza from pizzas where nombre='Snoopy')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('ternera','chorizo','cebolla','champiñones')


set @idpizza=(select idPizza from pizzas where nombre='Venezzia')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('atun','gambas','queso de cabra','calabacín')


set @idpizza=(select idPizza from pizzas where nombre='Piccola')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('ternera','Rúcula','cebolla','champiñones','salsas varias','parmesano')


set @idpizza=(select idPizza from pizzas where nombre='Maremonti')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('pimiento rojo','cebolla','champiñones','gambas','queso de cabra')


set @idpizza=(select idPizza from pizzas where nombre='Genoveva')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('alcachofas','york','cebolla','champiñones','gorgonzola')


set @idpizza=(select idPizza from pizzas where nombre='Suprema')
insert into PizzaIngredientes
select @idPizza,idIngrediente from Ingredientes where nombre in ('bacon','cebolla','champiñones','cherries','calabacín')
...
select * from pizzas
INSERT INTO [Clientes] (nombre,telefono,email,direccion,cod_postal,ComAutonoma,Pais,alphanumeric)
VALUES
...
BEGIN
    ...
    BEGIN
        insert into Detalle
        select @idpedido,idPizza,cast(RAND(CHECKSUM(NEWID())) * 3 as INT)+1,precio from pizzas where idpizza=cast(RAND(CHECKSUM(NEWID())) * (select count(1) from pizzas) as INT)+1
...
alter table clientes add contrasenya varchar(100) not null DEFAULT '12345Ab##'
go
update clientes set contrasenya=alphanumeric
alter table clientes drop column alphanumeric