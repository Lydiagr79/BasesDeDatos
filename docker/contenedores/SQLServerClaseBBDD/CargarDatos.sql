...
BULK INSERT rawjugadores FROM '/var/opt/mssql/backup/randomperson.csv'
   WITH (
      FIELDTERMINATOR = ',',
      ROWTERMINATOR = '0x0a'
);
...
BULK INSERT rawdataplayer FROM '/var/opt/mssql/backup/players.csv'
   WITH (
      FIELDTERMINATOR = ',',
      ROWTERMINATOR = '0x0a'
);
...
BULK INSERT rawdata FROM '/var/opt/mssql/backup/nba.csv'
   WITH (
      FIELDTERMINATOR = ',',
      ROWTERMINATOR = '0x0a'
);
...
PRINT '###########################################################################'
PRINT ''
PRINT 'Base de Datos AdventureWorks .....'
PRINT ''
PRINT '###########################################################################'
PRINT '###########################################################################'
PRINT '###########################################################################'
...
WITH REPLACE, MOVE 'AdventureWorks2017'  
TO '/var/opt/mssql/data/AdventureWorks2017_Data.mdf',  
MOVE 'AdventureWorks2017_Log'  
TO '/var/opt/mssql/data/AdventureWorks2017_Data.ldf';    
GO
...
RESTORE DATABASE Soccer  
FROM DISK = N'/var/opt/mssql/backup/soccer.bak'  
WITH REPLACE    
GO
...
PRINT '###########################################################################'
PRINT ''
PRINT '¡TODO LISTO! YA PUEDES CONECTARTE DESDE AzureDataStudio / SQL Server Management Studio o el cliente SQL que tu prefieras' 
PRINT ''
PRINT '###########################################################################'
PRINT '###########################################################################'
PRINT '###########################################################################'
