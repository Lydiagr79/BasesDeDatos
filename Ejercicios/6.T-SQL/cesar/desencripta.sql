go
create or alter function desencripta (@msg as varchar(8000))
    ...
    begin 
        ...
        BEGIN
            ...
            begin
                ...
                if @contador1 =1
                begin 
                    set @resultado = @resultado + SUBSTRING(@alfabeto,@numclave,1)
                    
                    end
                ELSE
                    set @resultado = @resultado + SUBSTRING(@alfabeto,@contador1-1,1)
